---
title: Antdv Next v1.0 发布：升级 Ant Design v6
datetime: 2026-02-03
author: aibayanyu20
---
...
由于本项目并非基于 Ant Design Vue 进行二次开发，因此我们在 API 上并未与其完全保持一致，在使用过程中可能会有一些差异。

如果您的项目刚起步，想要升级到我们的项目，建议参考我们的[迁移指南](/docs/vue/migration-antdv-next-cn)
